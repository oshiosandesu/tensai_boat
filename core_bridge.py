...
- core の関数を再公開（re-export）。無い関数はフォールバック実装で補う。
"""
...
# normalize_with_dynamic_alpha フォールバック
...
# evaluate_candidates_with_overbet フォールバック
...
# allocate_budget_safely フォールバック
